var CubicBezier = function CubicBezier(p1x, p1y, p2x, p2y, functionName) {
  ...
  var BezierEasing = function (t) {
    return this$1.sampleCurveY(this$1.solveCurveX(t))
  }

  // this function needs a name
  Object.defineProperty(BezierEasing, 'name', { writable: true })
  BezierEasing.name =
    functionName || 'cubic-bezier(' + [p1x, p1y, p2x, p2y] + ')'
 ...
 */
CubicBezier.prototype.sampleCurveDerivativeX = function sampleCurveDerivativeX(
  t
) {
